...
/*! \file nef_input_validation.hpp
 \brief Header-only helper functions for validating JSON request body fields.
        Returns an error string on failure, empty string on success.
        Callers should return HTTP 422 Unprocessable Entity on validation failure.
 */
