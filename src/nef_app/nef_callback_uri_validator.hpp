...
/*! \file nef_callback_uri_validator.hpp
 \brief SSRF protection: validates AF-supplied callback URIs before storage.
        Rejects non-http(s) schemes and IP-literal hosts that fall in blocked
        ranges (loopback, link-local, RFC 1918, IPv6 ULA).
        Hostname-based URIs are accepted — DNS-rebinding protection requires
        network-level controls and is out of scope here.
 */
