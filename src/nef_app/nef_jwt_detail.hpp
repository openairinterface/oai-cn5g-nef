...
/*! \file nef_jwt_detail.hpp
 \brief Pure helpers for JWT base64url coding and HMAC-SHA256 verification.
        Separated out so that unit tests can exercise them without depending on
        the NEF config singleton.
 \author  OAI
 \date 2024
 */
