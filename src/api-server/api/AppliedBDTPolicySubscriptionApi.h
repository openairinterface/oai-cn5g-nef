 ...
 */
/*
 * AppliedBDTPolicySubscriptionApi.h
 *
 *
 */

#ifndef AppliedBDTPolicySubscriptionApi_H_
#define AppliedBDTPolicySubscriptionApi_H_
...
class AppliedBDTPolicySubscriptionApi {
 public:
  explicit AppliedBDTPolicySubscriptionApi(
      const std::shared_ptr<Pistache::Rest::Router>& rtr);
  virtual ~AppliedBDTPolicySubscriptionApi() = default;
  void init();
 ...
 private:
  ...
  void af_id_subscriptions_post_handler(
      const Pistache::Rest::Request& request,
      Pistache::Http::ResponseWriter response);
  void applied_bdt_policy_subscription_api_default_handler(
      const Pistache::Rest::Request& request,
      Pistache::Http::ResponseWriter response);
  ...
  /// </remarks>
  /// <param name="afId">Identifier of the AF</param>
  /// <param name="appliedBdtPolicy">Request to create a new subscription
  /// resource</param>
  virtual void af_id_subscriptions_post(
      const std::string& afId,
      const oai::nef::model::AppliedBdtPolicy& appliedBdtPolicy,
      Pistache::Http::ResponseWriter& response) = 0;
};

}  // namespace oai::nef::api

#endif /* AppliedBDTPolicySubscriptionApi_H_ */
