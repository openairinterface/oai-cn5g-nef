...
const std::string IndividualTrafficInfluenceSubscriptionApi::base =
...
IndividualTrafficInfluenceSubscriptionApi::handleParsingException(
...
std::pair<Pistache::Http::Code, std::string>
IndividualTrafficInfluenceSubscriptionApi::handleOperationException(
    const std::exception& ex) const noexcept {
  return std::make_pair(Pistache::Http::Code::Internal_Server_Error, ex.what());
}

void IndividualTrafficInfluenceSubscriptionApi::
    af_id_subscriptions_subscription_id_delete_handler(
...
void IndividualTrafficInfluenceSubscriptionApi::
  ...
  try {
    ...
    try {
      nlohmann::json::parse(request.body()).get_to(trafficInfluSubPatch);
      trafficInfluSubPatch.validate();
    } catch (std::exception& e) {
      const std::pair<Pistache::Http::Code, std::string> errorInfo =
    ...
    try {
      this->af_id_subscriptions_subscription_id_patch(
          afId, subscriptionId, trafficInfluSubPatch, response);
    } catch (Pistache::Http::HttpError& e) {
      response.send(static_cast<Pistache::Http::Code>(e.code()), e.what());
      return;
    } catch (std::exception& e) {
