...
std::vector<GeographicArea> LocationArea5G::getGeographicAreas() const {
...
std::vector<CivicAddress> LocationArea5G::getCivicAddresses() const {
...
NetworkAreaInfo LocationArea5G::getNwAreaInfo() const {
  return m_NwAreaInfo;
}
