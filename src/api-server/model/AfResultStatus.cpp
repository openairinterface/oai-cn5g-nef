...
bool AfResultStatus::validate(std::stringstream& msg,
...
AfResultStatus_anyOf AfResultStatus::getValue() const { return m_value; }

void AfResultStatus::setValue(AfResultStatus_anyOf value) { m_value = value; }
