...
bool LocationInfo::validate(std::stringstream& msg,
...
std::string LocationInfo::getCellId() const { return m_CellId; }
void LocationInfo::setCellId(std::string const& value) {
  m_CellId = value;
  m_CellIdIsSet = true;
}
bool LocationInfo::cellIdIsSet() const { return m_CellIdIsSet; }
void LocationInfo::unsetCellId() { m_CellIdIsSet = false; }
std::string LocationInfo::getEnodeBId() const { return m_EnodeBId; }
void LocationInfo::setEnodeBId(std::string const& value) {
  m_EnodeBId = value;
  m_EnodeBIdIsSet = true;
}
bool LocationInfo::enodeBIdIsSet() const { return m_EnodeBIdIsSet; }
void LocationInfo::unsetEnodeBId() { m_EnodeBIdIsSet = false; }
std::string LocationInfo::getRoutingAreaId() const { return m_RoutingAreaId; }
void LocationInfo::setRoutingAreaId(std::string const& value) {
  m_RoutingAreaId = value;
  m_RoutingAreaIdIsSet = true;
}
bool LocationInfo::routingAreaIdIsSet() const { return m_RoutingAreaIdIsSet; }
void LocationInfo::unsetRoutingAreaId() { m_RoutingAreaIdIsSet = false; }
std::string LocationInfo::getTrackingAreaId() const { return m_TrackingAreaId; }
void LocationInfo::setTrackingAreaId(std::string const& value) {
  m_TrackingAreaId = value;
  m_TrackingAreaIdIsSet = true;
}
bool LocationInfo::trackingAreaIdIsSet() const { return m_TrackingAreaIdIsSet; }
void LocationInfo::unsetTrackingAreaId() { m_TrackingAreaIdIsSet = false; }
std::string LocationInfo::getPlmnId() const { return m_PlmnId; }
void LocationInfo::setPlmnId(std::string const& value) {
  m_PlmnId = value;
  m_PlmnIdIsSet = true;
}
bool LocationInfo::plmnIdIsSet() const { return m_PlmnIdIsSet; }
void LocationInfo::unsetPlmnId() { m_PlmnIdIsSet = false; }
std::string LocationInfo::getTwanId() const { return m_TwanId; }
void LocationInfo::setTwanId(std::string const& value) {
  m_TwanId = value;
  m_TwanIdIsSet = true;
}
bool LocationInfo::twanIdIsSet() const { return m_TwanIdIsSet; }
void LocationInfo::unsetTwanId() { m_TwanIdIsSet = false; }
...
bool LocationInfo::geographicAreaIsSet() const { return m_GeographicAreaIsSet; }
void LocationInfo::unsetGeographicArea() { m_GeographicAreaIsSet = false; }
CivicAddress LocationInfo::getCivicAddress() const { return m_CivicAddress; }
void LocationInfo::setCivicAddress(CivicAddress const& value) {
  m_CivicAddress = value;
  m_CivicAddressIsSet = true;
}
bool LocationInfo::civicAddressIsSet() const { return m_CivicAddressIsSet; }
void LocationInfo::unsetCivicAddress() { m_CivicAddressIsSet = false; }
...
bool LocationInfo::positionMethodIsSet() const { return m_PositionMethodIsSet; }
void LocationInfo::unsetPositionMethod() { m_PositionMethodIsSet = false; }
...
bool LocationInfo::qosFulfilIndIsSet() const { return m_QosFulfilIndIsSet; }
void LocationInfo::unsetQosFulfilInd() { m_QosFulfilIndIsSet = false; }
VelocityEstimate LocationInfo::getUeVelocity() const { return m_UeVelocity; }
void LocationInfo::setUeVelocity(VelocityEstimate const& value) {
  m_UeVelocity = value;
  m_UeVelocityIsSet = true;
}
bool LocationInfo::ueVelocityIsSet() const { return m_UeVelocityIsSet; }
void LocationInfo::unsetUeVelocity() { m_UeVelocityIsSet = false; }
LdrType LocationInfo::getLdrType() const { return m_LdrType; }
void LocationInfo::setLdrType(LdrType const& value) {
  m_LdrType = value;
  m_LdrTypeIsSet = true;
}
bool LocationInfo::ldrTypeIsSet() const { return m_LdrTypeIsSet; }
void LocationInfo::unsetLdrType() { m_LdrTypeIsSet = false; }
