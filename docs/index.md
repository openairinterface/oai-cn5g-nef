...
| TS 29.522 | QoS Monitoring (AS Session with QoS) | Implemented | [api-reference/qos-monitoring.md](api-reference/qos-monitoring.md) |
| TS 29.591 | Nnef_EventExposure (SBI) | Implemented | [api-reference/nnef-event-exposure.md](api-reference/nnef-event-exposure.md) |
| TS 29.591 | Analytics Exposure | Partially implemented | [api-reference/analytics-exposure.md](api-reference/analytics-exposure.md) |
...
| PFD Management (T8) | TS 29.551 | `/3gpp-pfd-management/v1/` | [api-reference/pfd-management.md](api-reference/pfd-management.md) |
...
| QoS Monitoring | TS 29.522 | `/3gpp-as-session-with-qos/v1/` | [api-reference/qos-monitoring.md](api-reference/qos-monitoring.md) |
| BDT Policy Control | TS 29.122 | `/3gpp-bdt/v1/` | [api-reference/bdt-policy.md](api-reference/bdt-policy.md) |
| Analytics Exposure | TS 29.591 | `/3gpp-analyticsexposure/v1/` | [api-reference/analytics-exposure.md](api-reference/analytics-exposure.md) |
...
- **CAPIF (TS 29.222)** — The repository includes 11 CAPIF specification YAML files (`TS29222_CAPIF_*.yaml`) in the `3gpp_specs/` directory for reference. No CAPIF endpoints are functional; no source handlers exist. See the CAPIF note below.
...
- **Full NWDAF Analytics** — Analytics exposure (TS 29.591 `/3gpp-analyticsexposure/`) is partially implemented; not all analytics event types are supported.
...
>
> The repository includes 11 CAPIF specification YAML files in `3gpp_specs/` for reference:
> `TS29222_CAPIF_Discover_Service_API.yaml`, `TS29222_CAPIF_Access_Control_Policy_API.yaml`,
> `TS29222_CAPIF_Security_API.yaml`, and 8 additional CAPIF files. These files are included
...
| [Architecture](architecture.md) | NEF in the 5GC topology, internal module breakdown, startup sequence |
...
| [PFD Management API](api-reference/pfd-management.md) | TS 29.551 — Manage Packet Flow Descriptions via UDR |
| [QoS Monitoring API](api-reference/qos-monitoring.md) | TS 29.522 — Subscribe to QoS session quality metrics |
| [BDT Policy API](api-reference/bdt-policy.md) | TS 29.122 — Background Data Transfer policy management |
| [Analytics Exposure API](api-reference/analytics-exposure.md) | TS 29.591 — Fetch analytics data from NWDAF (partial) |
...
See [CHANGELOG.md](../CHANGELOG.md) for a full list of changes across all releases.
